...
**2026-09-09 업무 개선:** 차량 시안 적용, 받은 품목 기준 부분 수거, 리프트권 추가 적재 제한, 장비교환의 전달·회수 연결과 일부 조기반납·수거 일정 분리를 구현했습니다. [요구사항·연결 규칙·검증 및 배포 기록](docs/28-vehicle-exchange-early-return-improvements.md)을 참고하세요.
